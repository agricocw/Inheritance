...
public class SalaryWorkerTest {
    ...
    public void testCalculateWeeklyPay() {
        ...
        assertEquals(2307.69, weeklyPay, 0.01); // Assuming 120000.0 / 52.0 for weekly pay
    }
    ...
    public void testCalculateWeeklyPayWithDifferentHourlyRate() {
        // Test calculating weekly pay with a different hourly rate
    ...
    public void testDisplayWeeklyPayWithDifferentHourlyRate() {
        // Test displaying weekly pay with a different hourly rate
        SalaryWorker salaryWorker = new SalaryWorker("Eva", "Williams", "SW005", "Mrs.", 1995, 28.0, 90000.0);
        String display = salaryWorker.displayWeeklyPay(40.0);
        assertEquals("Weekly pay is a fraction of the yearly salary: $1730.77", display);
    }
